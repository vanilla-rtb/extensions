...
type SspFeed struct {
	id                          uint32 `cpp:"uint16_t" ipc:"uint16_t" is_key:"yes"`
	notification_type_id        uint32 `cpp:"uint16_t" ipc:"uint16_t" is_value:"yes"`
	ssp_id                      uint32 `cpp:"uint16_t" ipc:"uint16_t" is_value:"yes"`
	bid_request_format_type_id  uint32 `cpp:"uint16_t" ipc:"uint16_t" is_value:"yes"`
	bid_response_format_type_id uint32 `cpp:"uint16_t" ipc:"uint16_t" is_value:"yes"`
	status                      uint32 `cpp:"uint16_t" ipc:"uint16_t" is_value:"yes"`
}
